...
import { filterMockProducts, MOCK_COLLECTIONS, MOCK_CATEGORIES, type ProductSearchParams } from "@/lib/medusa-client";
...
const ProductsPage = () => {
  ...
  const searchConfig: ProductSearchParams = useMemo(() => ({
    ...
    order: sort !== "relevance" ? sort : undefined,
    offset: (page - 1) * ITEMS_PER_PAGE,
    limit: ITEMS_PER_PAGE,
  }), [query, selectedCollections, sort, page]);

  const { products, count } = useMemo(() => filterMockProducts(searchConfig), [searchConfig]);
          ...
          <aside className="hidden lg:block w-64 shrink-0 space-y-6">
            ...
            <div>
              ...
              <div className="space-y-1">
                {MOCK_CATEGORIES.slice(0, 4).flatMap((cat) =>
